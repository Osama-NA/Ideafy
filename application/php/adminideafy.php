<?php 
    session_start();
    //IF NOT SIGNED IN AS USER REDIRECTS TO HOME
...
<head>
    ...
    <link rel="stylesheet" href="../css/adminideafy.css">    
...
<body>
    <div id="nav">
        ...
        <a href="./editgenerator.php" id="edit-generator">Edit generator</a>
        <a href="./addnewuser.php" id="add-user">Add user</a>
